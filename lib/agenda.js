 ...
 *********************************/
 ...
 Agenda.prototype.every = function(interval, names, options, data) {
   var self = this;
   if (typeof names === 'string' || names instanceof String) {
     return createJob(interval, names, options, data);
   } else if (Array.isArray(names)) {
     return createJobs(interval, names, options, data);
   }

   function createJob(interval, name, options, data) {
   ...
   function createJobs(interval, names, options, data) {
     return names.map(function (name) {
       return createJob(interval, name, options, data);
     });
   }
 };
